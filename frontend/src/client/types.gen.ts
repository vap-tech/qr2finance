...
export type Body_receipts_create_receipt_from_raw_file = {
    file: (Blob | File);
};
...
export type ReceiptRead = {
    ...
    total_sum: number;
    prepaid_sum: number;
    provision_sum: number;
    fiscal_document_format_ver: number;
    ...
    applied_taxation_type?: (number | null);
    shop_id: string;
...
export type ReceiptSource = 'manual' | 'fns_import' | 'external_import';

export type ReceiptsShortPublic = {
    data: Array<ReceiptShort>;
    count: number;
};

export type ReceiptStatus = 'draft' | 'finalized' | 'archived';

/**
 * Full representation of a receipt with nested items and related entities.
 */
export type ReceiptWithItemsFullPublic = {
    receipt: ReceiptRead;
...
export type ReceiptsReadReceiptResponse = (ReceiptWithItemsFullPublic);
...
export type ReceiptsAddReceiptItemsResponse = (ReceiptWithItemsPublic);

export type ReceiptsCreateReceiptFromRawJsonData = {
    requestBody: ({
    [key: string]: unknown;
} | Array<{
    [key: string]: unknown;
...
export type ReceiptsCreateReceiptFromRawJsonResponse = (ReceiptWithItemsPublic);

export type ReceiptsCreateReceiptFromRawFileData = {
    formData: Body_receipts_create_receipt_from_raw_file;
};
