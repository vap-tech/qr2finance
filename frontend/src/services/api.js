...
export const receiptsAPI = {
  getReceipts: (skip = 0, limit = 100) => api.get('/receipts', { params: { skip, limit } }),
  uploadReceipt: (file) => {
...
export const analyticsAPI = {
  ...
  getMonthlyStats: (year = 2026) => api.get('/analytics/monthly-stats', { params: { year } }),
...
export const storesAPI = {
  getStores: (skip = 0, limit = 100) => api.get('/stores/', { params: { skip, limit } }),
